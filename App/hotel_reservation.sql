...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2023 at 07:25 AM
...
(10, 'asd', 'ad', 'asdasdasdas', 'asd', 'asd', 'sad', 'male', 'asd', 'asd', 1234567890),
(11, 'aaa', 'aa', 'aaaaaaaaaaa', 'aa', 'aa', 'aa', 'male', 'aa', 'aa', 1234567891);
...
--
ALTER TABLE `customer`
  MODIFY `guest_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
